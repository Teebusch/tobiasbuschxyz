...
![a ggplot figure with the classic theme](./images/fig1_normal.png 'I am the caption now')
...
Has this blog post helped you? Do you know other packages that remove things which don't spark joy? [Tell me about it!](mailto:hello@tobiasbusch.xyz)

_Cover Photo by Clem Onojeghuo on Unsplash_
